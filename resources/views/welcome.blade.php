...
<body class="font-sans antialiased bg-slate-50 text-slate-800">
    ...
    <section id="services-list" class="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-visible">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 overflow-visible">
            ...
            @endphp
            <div class="bg-white rounded-3xl shadow-sm border border-slate-100 flex flex-col group {{ $borderPreset }} smooth-card-motion running-border-active smooth-card-motion rounded-[28px]">
